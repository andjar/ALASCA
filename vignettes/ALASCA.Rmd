...
ggpubr::ggarrange(
  ...
  ggpubr::ggarrange(plot(res.simple, effect = "time", only = "score", component = 2) + theme_bw(), 
                    plot(res.simple, effect = "time", only = "loading", component = 2) + theme_bw(), 
                    plot(res.simple, effect = "group", only = "score", component = 2) + theme_bw(), 
                    plot(res.simple, effect = "group", only = "loading", component = 2) + theme_bw(), 
                    nrow = 1, widths = c(2,3,2,3), 
                    common.legend = TRUE, legend = "bottom"),
  nrow = 2
)
