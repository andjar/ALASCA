...
In addition, I am interested in inflammatory proteins, so let us add interleukins and interferons.

```{r}
df <- merge(df, somaids, by.x = "variable", by.y = "SomaId") # add protein names
selectedVariables <- c(which(df$variable %in% c("SL000525", "SL002640", "SL005217", "SL003166")),
